...
def social_button(app, icon, text, button_id):
    return html.Div(
        className="transform hover:scale-105 transition duration-300 shadow-2xl rounded-lg col-span-12 sm:col-span-1 xl:col-span-2 intro-y bg-gradient-to-r from-yellow-300 to-yellow-100 text-white-600 px-4 py-2 grid grid-cols-2",
        children=[
            html.Img(src=app.get_asset_url(icon), style={'width': '50px', 'height': '50px'}),
            html.Button(text, id=button_id, n_clicks=0, className="bg-yellow-400 hover:bg-yellow-500 text-white font-bold py-2 px-4 rounded-full m-2")])
                ...
                html.Div(
                    ...
                    children=[
                        html.Div(
                            ...
                            children=[
                                html.Img(src=app.get_asset_url("Lemus.jpg"), style={'width': '200px', 'height': '200px', 'border-radius': '50%'}),
                            ]
                        ),
                        html.Br(),
                        html.H1("Pablo Lemus", className="text-center text-3xl font-bold leading-8 text-yellow-600"),
                        html.H2("Gobernador 2024-2030", className="text-center text-3xl font-bold leading-8 text-yellow-600"),
                        html.Br(),
                        social_button(app, 'tik-tok.png', 'TikTok', 'button-1'),
                        html.Br(),
                        social_button(app, 'gorjeo.png', 'Twitter', 'button-2'),
                        html.Br(),
